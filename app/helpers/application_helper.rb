module ApplicationHelper
  def login_helper style = ''
    if current_user.is_a?(GuestUser)
      (link_to "Registrar", new_user_registration_path, class: style) +
      " ".html_safe +
      (link_to "Iniciar Sesion", new_user_session_path, class: style)
    else
      link_to "Salir", destroy_user_session_path, method: :delete, class: style
    end
  end
  ...
  def alert_generator msg
    js add_gritter(msg, title: "mgznv portfolio", sticky: false)
  end
end
